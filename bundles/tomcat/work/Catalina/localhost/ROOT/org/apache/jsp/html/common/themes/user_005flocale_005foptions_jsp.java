...
public final class user_005flocale_005foptions_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/html/common/themes/init.jsp", Long.valueOf(1712363247059L));
  }
...
String currentURL = PortalUtil.getCurrentURL(request);
	...
	Locale userLocale = user.getLocale();
          ...
          try {
            ...
            if (_jspx_eval_c_005fif_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              try {
                ...
                _jspx_th_aui_005fa_005f0.setHref( themeDisplay.getPathMain() + "/portal/update_language?redirect=" + URLCodec.encodeURL(currentURL) + "&groupId=" + themeDisplay.getScopeGroupId() + "&languageId=" + user.getLanguageId() + "&layoutId=" + layout.getLayoutId() + "&persistState=false&showUserLocaleOptionsMessage=false" );
          ...
          try {
            ...
            _jspx_th_aui_005fa_005f1.setHref( themeDisplay.getPathMain() + "/portal/update_language?redirect=" + URLCodec.encodeURL(currentURL) + "&groupId=" + themeDisplay.getScopeGroupId() + "&languageId=" + themeDisplay.getLanguageId() + "&layoutId=" + layout.getLayoutId() + "&showUserLocaleOptionsMessage=false" );
